...
activities = {
    ...
    "Soccer Club": {
        ...
        "max_participants": 22,
        "participants": ["luke@mergington.edu", "mina@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Drama Club": {
        ...
        "schedule": "Thursdays and Fridays, 4:00 PM - 6:30 PM",
        "max_participants": 25,
    ...
    "Math Club": {
        "description": "Problem-solving sessions, contests, and math enrichment",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
